...
Route::post('/update-education', [ResumeEduController::class, 'updateResumeEdu'])->middleware([TokenverifyMiddleware::class]);
Route::post('/delete-education', [ResumeEduController::class, 'deleteResumeEdu'])->middleware([TokenverifyMiddleware::class]);
Route::get('/resume-education-list', [ResumeEduController::class, 'resumeEduList'])->middleware([TokenverifyMiddleware::class]);
Route::get('/resume-edu-update-by-id', [ResumeEduController::class, 'resumeEduUpdateById'])->middleware([TokenverifyMiddleware::class]);

// Resume academic edu page for admin
Route::get('/education-page', [ResumeEduController::class, 'resumeEduFontPage'])->middleware([TokenverifyMiddleware::class]);
...
Route::post('/update-pro-education', [ResumeProEduController::class, 'updateResumeProEdu'])->middleware([TokenverifyMiddleware::class]);
Route::post('/delete-pro-education', [ResumeProEduController::class, 'deleteResumeEdu'])->middleware([TokenverifyMiddleware::class]);
...
Route::get('/resume-pro-education-update-by-id', [ResumeProEduController::class, 'resumeProEduUpdateById'])->middleware([TokenverifyMiddleware::class]);

// pro edu page for admin
Route::get('/pro-education-page', [ResumeProEduController::class, 'proEduPage'])->middleware([TokenverifyMiddleware::class]);
