<div class="modal" tabindex="-1" id="skill-delete-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="fs-3 text-center text-primary">Are you sure, want to delete this item?</p>
            ...
            <div class="modal-footer">
                ...
                <button onclick="SkillDelete()" type="button" class="btn btn-danger" id="deleteIt">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    async function SkillDelete() {
        ...
        showLoader();
        let res = await axios.post('/skill-delete', {
            id: id
        });
        hideLoader();
