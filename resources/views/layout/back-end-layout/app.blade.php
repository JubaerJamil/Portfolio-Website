...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item mb-2 mt-0">
                    <a data-bs-toggle="collapse" href="#ProfileNav" class="nav-link text-white"
                        ...
                        <img src="{{ asset('img/team-4.jpg') }}" class="avatar">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="dashboardsExamples" style="">
                        ...
                        <div class="collapse show">
                            <ul class="nav ">
                                <li class="nav-item ">
                                    <a class="nav-link text-white link-success" href="{{ url('/education-page') }}">
                                        <span class="sidenav-mini-icon"> C </span>
                                        <span class="sidenav-normal  ms-2  ps-1">Academic Education</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="collapse show">
                            <ul class="nav ">
                                <li class="nav-item ">
                                    <a class="nav-link text-white link-success"
                                        href="{{ url('/pro-education-page') }}">
                                        <span class="sidenav-mini-icon"> D </span>
                                        <span class="sidenav-normal  ms-2  ps-1">Professional Education</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    <main class="main-content border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky bg-info"
